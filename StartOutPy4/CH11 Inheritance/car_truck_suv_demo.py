...
def main():
    # Create a Car object ofr a used 2001 BMW with 70,000 miles, priced at $15,000, with 4 doors.
    ...
    # Volvo with 30,000 miles, priced at $18,500, with 5 passenger capacity.
    suv = vehicles.SUV('Volvo', 2000, 30000, 185000.0, 5)

    print('USED CAR INVENTROY')
    print('===================')

    # Display the car's data.
    print('The followinng car is in inventory.')
    ...
    print('The following SUV is in a inventory.')
