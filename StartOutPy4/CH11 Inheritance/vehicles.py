...
# abouut an automobile in inventory.
class Automobile:
    ...
    # The following methods are mutatorss for the
...
# of the Automobile clas
class Car(Automobile):
    # The __init__method accepts arguments for the
    # car's make, model, mileage, price, and doors.
    def __init__(self, make, model, mileage, price, doors):
        # Call the superclasss's __init__ method and pass
...
class Truck(Automobile):
    ...
    def set_drive_type(self, drive_type):
        self.__drive_type = drive_type
    # The get_drive_type method is the accessor the for the
    # __drive_type attribute.
...
class SUV(Automobile):
    ...
    def __init__(self, make, model, mileage, price, pass_cap):
        # Call the superclass's __init__ method and pass
        # the required arguements. Note that we also have
        # to pass self as an arguement.
        Automobile.__init__(self, make, model, mileage, price)
